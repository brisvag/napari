    ...
    def _update_overlay_canvas_positions(self, event=None):
        ...
        for view in views:
            ...
            for (
                overlay,
                vispy_overlay,
            ) in self._get_ordered_visible_canvas_overlays_in_view(view):
